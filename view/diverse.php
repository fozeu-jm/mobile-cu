...
<html lang="fr">
    ...
    <body style="position: relative;" class="animsition">
                            ...
                            <div style="height: 100px; position: relative;" class="card ">
                                <div  class="card-header02 ">
                                    <div style="text-align: center;" class="header-icon purple" >
                                        <img  class="" src="view/images/icon/donate-48.png" alt=""/>
                                        <h2 class="title-1 " style="display: inline; vertical-align: middle;">
                                            <span style=" border-right: 2px solid white; padding-right: 20px;" class="text-white">Diverse</span>                       
                                        </h2>
                                        <span style="color: white;; font-size: 1.6em; vertical-align: middle;">Gestion Des Contribution Diverse</span>
                                    </div> 
                                </div>
                            </div>
                        </div>
                    ...
                    <?php if (!is_bool($cycle12)) { ?>
                            ...
                            <div class="col col-sm-12">
                                <div class="card2  ">
                                    ...
                                    <form class="row" id="search-form" method="post" action="index.php">
                                        ...
                                        <input style="display: none;" type="text" name="action" value="print-diverse">
                                    </form>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div  class="card-header02">
                                            <div style=" margin-bottom: 15px; height: 70px; text-align: center;" class="header-icon purple" >
                                                <div style="margin-top: -7px;">
                                                    ...
                                                    <h2 class="title-1 " style=" display: inline; vertical-align: middle;">
                                                        <span style="margin-top: -20px;" class="hey text-white">Diverse</span>                       
                                                    </h2>
                                                </div>
                                            </div> 
                                        </div>
                                            ...
                                            <div style="" class="row">
                                                <div class="col-12 ">
                                                    <table id="table-js"  class="table table-hover">
                                                        ...
                                                        foreach ($list as $con) {
                                                            ?>
                                                            <tr id="select<?= $con->getdivid() ?>" class="animate">
                                                                <td><?= $i; ?></td>
                                                                ...
                                                                <?php if (in_array($_SESSION['online']->getrole(), array('President', 'Vice-President', 'Comptable'))) { ?>
                                                                    <td> 
                                                                        <input id="actu-number1<?= $con->getdivid() ?>" style="display: none;" type="text" value="<?= $i ?>"/>
                                                                        <button data-toggle="modal" data-target="#modalLoginForm" class="edit_cycles" id="editcyc_<?= $con->getdivid() ?>"  >
                                                                            <img src="view/images/icon/edit.png" alt=""/>
                                                                        </button>
                                                                        <button class="delete_cycles" id="delcyc_<?= $con->getdivid() ?>">
                        ...
                        <div class="row">
                            <div style="margin-top: -40px;" class="col-6">
                                Nombre Totale de div-cont : <?= $nombre; ?>.
                            </div>
                            <div class="col-6">
                                <ul style="" class="pagination pagi">
                                    <?php if (!isset($_GET['page'])) { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == 1) {
                                                ?>
                                                <li class="active-page1 purple"><a  class="" href="index.php?action=diverse&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-purple" href="index.php?action=diverse&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == $_GET['page']) {
                                                ?>
                                                <li class="active-page1 purple"><a  class="text-purple" href="index.php?action=diverse&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-purple" href="index.php?action=diverse&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
        ...
        <script src="vendor/js/ajax-diverse.js"></script>
    </body>
</html>
<!-- end document-->
