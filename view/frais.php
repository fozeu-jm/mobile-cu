...
<html lang="fr">
    ...
    <body style="position: relative;" class="animsition">
                            ...
                            <div style="height: 100px; position: relative;" class="card ">
                                <div  class="card-header02 ">
                                    <div style="text-align: center;" class="header-icon app-color" >
                                        <img  class="" src="view/images/icon/manage-48.png" alt=""/>
                                        <h2 class="title-1 " style="display: inline; vertical-align: middle;">
                                            <span style=" border-right: 2px solid white; padding-right: 20px;" class="text-white">Bureau</span>                       
                                        </h2>
                                        <span class="sub-title" style="color: white;; font-size: 1.6em; vertical-align: middle;">Gestion des Commission Tontine Speciale</span>
                                    </div> 
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card2  ">
                                    ...
                                    <form class="row" id="search-form" method="post" action="index.php">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label style="margin-left:-40px;  display:block; text-align: center;" for="search-member">Recherche par Cycle </label>
                                                </div>
                                                <div class="col-12">
                                                    <div class="input-group">
                                                        <select id="search-index2" name="search-cycle" class="presi-filter  custom-select " style="border: #17a9a8 solid medium; border-radius: 40px; padding-left: 9px; height: 40px;" name="" id="">
                                                            <option value="" disabled="">Filter par cycles</option>
                                        ...
                                        <input style="display: none;" type="text" name="action" value="print-com">
                                    </form>
                                </div>
                            </div>
                        </div>
                            ...
                            <div style=" margin-bottom: 40px;" class="mem-table row mem-title">
                                <div class="col-sm-12 ">
                                    <div style="" class="card ">
                                        <div  class=" card-header02">
                                            <div style=" color: red; margin-bottom: 15px; height: 70px; text-align: center;" class="header-icon app-color" >
                                                <div  style="margin-top: -7px;">
                                                    <img  class="" src="view/images/icon/records.png" alt=""/>
                                                    <h2 class="title-1 " style=" display: inline; vertical-align: middle;">
                                                        <span style="margin-top: -20px;" class="hey text-white">Commisions</span>                       
                                                    </h2>
                                                </div>
                                            </div> 
                                        </div>
                                            ...
                                            <div style="" class="row">
                                                <div class="col-12 ">
                                                    <table id="table-js"  class="table table-hover">
                                                        ...
                                                        foreach ($list as $con) {
                                                            ?>
                                                            <tr id="select<?= $con->getscomid() ?>" class="animate">
                                                                <td><?= $i; ?></td>
                                                                <td > <?= number_format($con->getamount()) . ' FCFA' ?> </td>
                                                                <td > <?= $con->getrate() . ' %' ?> </td>
                                                                <td style="text-align: center;" > <?= $con->getcycle() ?> </td>
                                                                <?php if(in_array($_SESSION['online']->getrole(), array('President','Vice-President','Comptable'))) {?>
                                                                <td> 
                                                                    <input id="actu-number1<?= $con->getscomid() ?>" style="display: none;" type="text" value="<?= $i ?>"/>
                                                                    <button data-toggle="modal" data-target="#modalLoginForm" class="edit_cycles" id="editcyc_<?= $con->getscomid() ?>"  >
                                                                        <img src="view/images/icon/edit.png" alt=""/>
                                                                    </button>
                                                                    <button class="delete_cycles" id="delcyc_<?= $con->getscomid() ?>">
                                ...
                                <ul style="" class="pagination pagi">
                                    <?php if (!isset($_GET['page'])) { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == 1) {
                                                ?>
                                                <li class="active-page1 app-color"><a  class="" href="index.php?action=frais&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-app-color" href="index.php?action=frais&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == $_GET['page']) {
                                                ?>
                                                <li class="active-page1 app-color"><a  class="text-app-color" href="index.php?action=frais&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-app-color" href="index.php?action=frais&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                            ...
                            <div class="modal-content">
                                ...
                                <form action="#" id="modal-js">
                                    <div class="modal-body mx-3">
                                        ...
                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Taux</label>
                                            <input name="rate" type="number" value="0"id="rate-js"  class="form-control validate">
                                        </div>
        ...
        <script src="vendor/js/ajax-com.js"></script>
    </body>
</html>
<!-- end document-->
