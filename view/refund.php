            ...
            <div class="main-content">
                <div class="container-fluid">
                            ...
                            <div style="height: 100px; position: relative;" class="card ">
                                <div  class="card-header02 ">
                                    <div style="text-align: center;" class="header-icon app-color" >
                                        ...
                                        <span style="color: white;; font-size: 1.6em; vertical-align: middle;">Gestion Des Remboursements</span>
                                    </div> 
                                </div>
                            </div>
                        </div>
                    ...
                    <?php if (!is_bool($cycle12)) { ?>
                            ...
                            <div class="col col-sm-12">
                                <div class="card2  ">
                                    ...
                                    <form class="row" id="search-form" method="post" action="index.php">
                                        ...
                                        <input style="display: none;" type="text" name="action" value="print-refund">
                                    </form>
                                </div>
                            </div>
                        </div>
                        <!--**************loanrefund datatable****************************************************-->
                                        ...
                                        <div  class="card-header02">
                                            <div style=" margin-bottom: 15px; height: 70px; text-align: center;" class="header-icon app-color" >
                                                <div style="margin-top: -7px;">
                                                    ...
                                                    <h2 class="title-1 " style=" display: inline; vertical-align: middle;">
                                                        <span style="margin-top: -20px;" class="text-white">Remboursements</span>                       
                                                    </h2>
                                                </div>
                                            </div> 
                                        </div>
                                            ...
                                            <div style="" class="row">
                                                <div class="col-12 ">
                                                    <table id="table-js"  class="table table-hover">
                                                        ...
                                                        foreach ($list as $con) {
                                                            ?>
                                                            <tr id="select<?= $con->getrefid() ?>" class="animate">
                                                                <td><?= $i; ?></td>
                                                                ...
                                                                <?php if(in_array($_SESSION['online']->getrole(), array('President','Vice-President','Comptable'))) {?>
                                                                <td> 
                                                                    <input id="actu-number1<?= $con->getrefid() ?>" style="display: none;" type="text" value="<?= $i ?>"/>
                                                                   
                                                                    <button data-toggle="modal" data-target="#modalLoginForm" class="edit_cycles" id="editcyc_<?= $con->getrefid() ?>"  >
                                                                        <img src="view/images/icon/edit.png" alt=""/>
                                                                    </button>
                                                                    <button class="delete_cycles" id="delcyc_<?= $con->getrefid() ?>">
                        ...
                        <?php if(in_array($_SESSION['online']->getrole(), array('President','Vice-President','Comptable'))) {?>
                        <button id="fixedadd-btn" style="display: none;position: fixed; bottom: 0; right: 0px; " class="app-color btn-floating2" data-toggle="modal" data-target="#modalLoginForm">
                        ...
                        <div class="row">
                            <div style="margin-top: -40px;" class="col-6">
                                Nombre Totale de remboursements : <?= $nombre; ?>.
                            </div>
                            <div class="col-6">
                                <ul style="" class="pagination pagi">
                                    <?php if (!isset($_GET['page'])) { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == 1) {
                                                ?>
                                                <li class="active-page1 app-color"><a  class="" href="index.php?action=refund&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-app-color" href="index.php?action=refund&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == $_GET['page']) {
                                                ?>
                                                <li class="active-page1 blue"><a  class="text-app-color" href="index.php?action=refund&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-app-color" href="index.php?action=refund&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                            ...
                            <input style="display: none;" type="text" id="open-js" value="<?php if(isset($_GET['loanid'])){echo $_GET['loanid'];}else{echo -45;} ?>" class="form-control">
                        </div>
                        ...
                        <div  class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div  class="header-icon app-color modal-header text-center">
                                    <h4 id="modal-heading" class="modal-title text-white w-100 font-weight-bold">Remboursements Prêts</h4>
                                ...
                                <form action="#" id="modal-js">
                                    <div class="modal-body mx-3">
                                        <!-- HIDDEN ID OF REFUND OPERATION -->
                                        <div style="display: none;" class="md-form mb-5">
                                            <input name="ID" type="text" id="ID-JS" placeholder="ID" class="form-control validate">
                                        </div>
                                        <div class="md-form mb-4">
                                            <label style="margin-top: -35px;" for="dep-date">Noms</label>
                                            <select id="mem-js" class="form-control validate">
                                                <option value=""><?php if(isset($refloan)){ echo $refloan->getfullname(); } ?></option>
                                            </select>
                                        </div>
                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Date du prêt</label>
                                            <input id="ldate-js" readonly="true"  value="<?php if(isset($refloan)){ echo $refloan->getdate(); } ?>" type="text"  class="form-control validate" >
                                        </div>
                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Taux du prêt</label>
                                            <input id="lrate-js" readonly="true" value="<?php if(isset($refloan)){ echo $refloan->getrate(); } ?>" type="number" class="form-control validate" >
                                        </div>
                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Montant du Prêt</label>
                                            <input id="lamt-js" readonly="true"  value="<?php if(isset($refloan)){ echo $refloan->getamount(); } ?>" type="number"  class="form-control validate" >
                                        </div>
                                        <!--************* Start Of submissibles *************************-->
                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Montant Remboursement</label>
                                            <input name="amount" value="<?php if(isset($refloan)){ echo ($refloan->getrate()/100)*$refloan->getamount(); } ?>" type="number" id="amount-js" class="form-control validate" >
                                        </div>
                                        <div class="md-form mb-5">
                                        ...
                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Libellé</label>
                                            <select name="label" id="label-js" class="form-control validate">
                                                <option value="INTERET">INTERET</option>
                                                <option value="PRINCIPALE">PRINCIPALE</option>
                                            </select>
                                        </div>
                                        <!-- loan id hidden text field -->
                                        <input style="display:none;" id="LON-JS" name="loanid" class="form-control" type="text" value="<?php if(isset($refloan)){ echo $refloan->getloanid(); } ?>">
                                        <div class="md-form mb-4">
                ...
                <script src="vendor/js/ajax-refund.js"></script>
                </body>
                </html>
                <!-- end document-->
