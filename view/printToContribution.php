...
<page backtop="20mm" backleft="10mm" backright="10mm" backbottom="0mm">
        ...
        <table style="width: 400px; margin-top:60px; margin-left: -5px; ">
            <thead>
                <tr style="border-radius: 2px 2px 0px 0px; background:#697889; text-align:center; color:white; ">
                    ...
                    <th style="border:none;">Date Depot</th>
                    <th style="border:none;">Date Statutaire</th>
            ...
            foreach ($printlist as $mem) {
                ...
                <tr class="animate">
                    ...
                    <td style="width:35%;"class="bord"> <?= $mem->getfullname() ?> </td>
                    <td style="width:15%;text-align: center;"class="bord"> <?= $mem->getdepositdate() ?> </td>
                    <td style="width:15%;text-align: center;"class="bord"> <?= $mem->getmeetingdate() ?> </td>
                    <td style="width:20%;text-align: center;"class="bord"> <?= $mem->getlabels() ?> </td>
                    <td style="width:5%;text-align: center;"class="bord"> <?= $mem->gettord() ?> </td>
                    <td style="width:5%;text-align: center;"class="bord"> <?= $mem->getts() ?> </td>
                    <td style="width:20%;text-align: center;"class="bord"> <?= number_format($mem->getordinary()) ?> </td>
                    <td style="width:20%;text-align: center;"class="bord"> <?= number_format($mem->getspecial()) ?> </td>
                    <td style="width:15%;text-align: center;"class="bord"> <?= number_format($mem->getmeal()) ?> </td>
                </tr>
                <?php
                $to += $mem->gettord();
                $ts += $mem->getts();
            ...
            ?>
            <tr style="height: 35px; background:#697889; color: white;">
                <td colspan="5" style="text-align:  center; color: white;"> Totale</td>
    ...
    try {
        ...
        $pdf->output('journal mensuel-contribution-'.$monthname.'.pdf', 'I');
