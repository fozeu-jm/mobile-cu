...
<html lang="fr">
    ...
    <body style="position: relative;" class="animsition">
                            ...
                            <div style="height: 100px; position: relative;" class="card ">
                                <div  class="card-header02 ">
                                    <div style="text-align: center;" class="header-icon blue" >
                                        <img  class="" src="view/images/icon/buy-48.png" alt=""/>
                                        <h2 class="title-1 " style="display: inline; vertical-align: middle;">
                                            <span style=" border-right: 2px solid white; padding-right: 20px;" class="text-white">Depenses</span>                       
                                        </h2>
                                        <span style="color: white;; font-size: 1.6em; vertical-align: middle;">Gestion Des Diverses Dépenses</span>
                                    </div> 
                                </div>
                            </div>
                        </div>
                    ...
                    <?php if (!is_bool($cycle12)) { ?>
                                ...
                                <div class="card2  ">
                                    ...
                                    <form class="row" id="search-form" method="post" action="index.php">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label style="margin-left:-40px;  display:block; text-align: center;" for="search-member">Recherche Par Libellé </label>
                                                </div>
                                                <div class="col-12">
                                        ...
                                        <input style="display: none;" type="text" name="action" value="print-spend">
                                    </form>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div  class="card-header02">
                                            <div style=" margin-bottom: 15px; height: 70px; text-align: center;" class="header-icon blue" >
                                                <div style="margin-top: -7px;">
                                                    ...
                                                    <h2 class="title-1 " style=" display: inline; vertical-align: middle;">
                                                        <span style="margin-top: -20px;" class="hey text-white">Depenses</span>                       
                                                    </h2>
                                                </div>
                                            </div> 
                                        </div>
                                            ...
                                            <div style="" class="row">
                                                <div class="col-12 ">
                                                    <table id="table-js"  class="table table-hover">
                                                        ...
                                                        foreach ($list as $con) {
                                                            ?>
                                                            <tr id="select<?= $con->getexpid() ?>" class="animate">
                                                                <td><?= $i; ?></td>
                                                                ...
                                                                <?php if(in_array($_SESSION['online']->getrole(), array('President','Vice-President','Comptable'))) {?>
                                                                <td> 
                                                                    <input id="actu-number1<?= $con->getexpid() ?>" style="display: none;" type="text" value="<?= $i ?>"/>
                                                                    <button data-toggle="modal" data-target="#modalLoginForm" class="edit_cycles" id="editcyc_<?= $con->getexpid() ?>"  >
                                                                        <img src="view/images/icon/edit.png" alt=""/>
                                                                    </button>
                                                                    <button class="delete_cycles" id="delcyc_<?= $con->getexpid() ?>">
                        ...
                        <div class="row">
                            <div style="margin-top: -40px;" class="col-6">
                                Nombre Totale de Depenses : <?= $nombre; ?>.
                            </div>
                            <div class="col-6">
                                <ul style="" class="pagination pagi">
                                    <?php if (!isset($_GET['page'])) { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == 1) {
                                                ?>
                                                <li class="active-page1 blue"><a  class="" href="index.php?action=spend&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-blue" href="index.php?action=spend&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == $_GET['page']) {
                                                ?>
                                                <li class="active-page1 blue"><a  class="text-blue" href="index.php?action=spend&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-blue" href="index.php?action=spend&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                                ...
                                <form action="#" id="modal-js">
                                    <div class="modal-body mx-3">
                                        ...
                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Montant Dépensé</label>
                                            <input name="amount" value="0" type="number" id="amount-js" class="form-control validate" >
                                        </div>

                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">N° du Cheques</label>
                                        ...
                                        <div class="md-form mb-5">
                                            ...
                                            <input name="reason" type="text" id="reason-js"  class="form-control validate">
                                        </div>
        ...
        <script src="vendor/js/ajax-spend.js"></script>
    </body>
</html>
<!-- end document-->
