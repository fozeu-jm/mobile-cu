    ...
    <table style="width: 400px; margin-top:60px; margin-left: 0px;">
        ...
        foreach ($printlist as $mem) {
            ...
            <tr class="animate">
                ...
                <td style="width:35%;text-align: center;"class="bord"> <?= $mem->getchequesno() ?> </td>
        ...
        ?>
        <tr style="border-radius: 2px 2px 0px 0px; background:#697889; text-align:center; color:white; ">
            <td colspan="4" style="width:10%; text-align: center;"class="bord">Total</td>
...
try {
    ...
    $pdf->output('rapport-repas.pdf', 'I');
