...
<html lang="fr">
    ...
    <body style="position: relative;" class="animsition">
            ...
            <div class="main-content">
                <div class="container-fluid">
                            ...
                            <div style="height: 100px; position: relative;" class="card ">
                                <div  class="card-header02 ">
                                    <div style="text-align: center;" class="header-icon purple" >
                                        <img  class="" src="view/images/icon/sales-48.png" alt=""/>
                                        <h2 class="title-1 " style="display: inline; vertical-align: middle;">
                                            <span style=" border-right: 2px solid white; padding-right: 20px;" class="text-white"><?php echo $lang['sales']; ?></span>                       
                                        </h2>
                                        <span style="color: white;; font-size: 1.6em; vertical-align: middle;"><?php echo $lang['saleman']; ?></span>
                                    </div> 
                                </div>
                            </div>
                        </div>
                    ...
                    <?php if (!is_bool($cycle12)) { ?>
                                    ...
                                    <form class="row" id="search-form" method="post" action="index.php">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input name="search-name" id="search-index1" style=" display: block; border: #9d36b3 solid medium; border-radius: 40px; padding-left: 9px; height: 40px;" type="text" placeholder="Recherche..." class="form-control">
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="input-group">
                                                        <select id="search-index2" name="search-month" class="presi-filter  custom-select " style="border: #9d36b3 solid medium; border-radius: 40px; padding-left: 9px; height: 40px;" name="" id="">
                                        ...
                                        <div class="col-sm-12 col-md-4">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label style="margin-left:-40px;  display:block; text-align: center;" for="search-member">Recherche type Tontine </label>
                                                </div>
                                                <div class="col-12">
                                                    <div class="input-group">
                                                        <select id="search-index3" name="search-tontine" class="presi-filter  custom-select " style="border: #9d36b3 solid medium; border-radius: 40px; padding-left: 9px; height: 40px;" name="" id="">
                                        ...
                                        <input style="display: none;" type="text" name="action" value="print-sales">
                                    </form>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div  class="card-header02">
                                            <div style=" margin-bottom: 15px; height: 70px; text-align: center;" class="header-icon purple" >
                                                <div style="margin-top: -7px;">
                                                    ...
                                                    <h2 class="title-1 " style=" display: inline; vertical-align: middle;">
                                                        <span style="margin-top: -20px;" class="text-white"><?php  echo $lang['sales']; ?></span>                       
                                                    </h2>
                                                </div>
                                            </div> 
                                        </div>
                                            ...
                                            <div style="" class="row">
                                                <div class="col-12 ">
                                                    <table id="table-js"  class="table table-hover">
                                                        ...
                                                        foreach ($list as $con) {
                                                            ?>
                                                            <tr id="select<?= $con->gettsid() ?>" class="animate">
                                                                <td><?= $i; ?></td>
                                                                <td> <?= $con->getfullname() ?> </td>
                                                                <td > <?= number_format($con->getamount()) . ' FCFA' ?> </td>
                                                                <td > <?= number_format($con->getsellingprice()) . ' FCFA' ?> </td>
                                                                <td > <?= $con->getchequesno() ?> </td>
                                                                <td > <?= $con->getdate() ?> </td>
                                                                <td > <?= $con->gettype() ?> </td>
                                                                <?php if(in_array($_SESSION['online']->getrole(), array('President','Vice-President','Comptable'))) {?>
                                                                <td> 
                                                                    <input id="actu-number1<?= $con->gettsid() ?>" style="display: none;" type="text" value="<?= $i ?>"/>
                                                                    <button data-toggle="modal" data-target="#modalLoginForm" class="edit_cycles" id="editcyc_<?= $con->gettsid() ?>"  >
                                                                        <img src="view/images/icon/edit.png" alt=""/>
                                                                    </button>
                                                                    <button class="delete_cycles" id="delcyc_<?= $con->gettsid() ?>">
                        ...
                        <?php if(in_array($_SESSION['online']->getrole(), array('President','Vice-President','Comptable'))) {?>
                        <button id="fixedadd-btn" style="position: fixed; bottom: 0; right: 0px; " class="purple btn-floating2" data-toggle="modal" data-target="#modalLoginForm">
                            <img style="padding-top: 2px; padding-left: -1px;" src="view/images/icon/add.png" alt=""/>
                        </button>
                        <?php } ?>
                        <button type="fixedsubmit-btn" form="search-form" id="printcyc-btn" style="position: fixed; bottom: 0; right: 70px; bottom: 0px;"class="purple btn-floating2">
                                ...
                                <ul style="" class="pagination pagi">
                                    <?php if (!isset($_GET['page'])) { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == 1) {
                                                ?>
                                                <li class="active-page1 purple"><a  class="" href="index.php?action=sales&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-purple" href="index.php?action=sales&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == $_GET['page']) {
                                                ?>
                                                <li class="active-page1 purple"><a  class="text-purple" href="index.php?action=sales&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-purple" href="index.php?action=sales&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                                ...
                                <form action="#" id="modal-js">
                                    <div class="modal-body mx-3">
                                        ...
                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Montant du Lot</label>
                                            <input name="amount" value="0" type="number" id="amount-js" class="form-control validate" >
                                        </div>
                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Prix de vente</label>
                                            <input value="0" name="sell" type="number" id="sell-js" placeholder="" class="form-control validate" >
                                        </div>

                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Date (MM-JJ-AA)</label>
                                            <input value="<?= date("Y-m-d"); ?>"  name="date" type="date" id="date-js" placeholder="" class="form-control validate">
                                        </div>

                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Cheques</label>
                                            <input name="check" type="text" id="check-js"  class="form-control validate">
                                        </div>

                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Tontine</label>
                                            <select class="form-control validate" name="tontine" id="tontine-js">
                                                <option value="Ordinaire">Ordinaire</option>
                                                <option value="Speciale">Speciale</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="modal-footer d-flex justify-content-center">
                                        <button id="modaladd-js" data-dismiss="modal" aria-label="Close" class="btn purple">Creer</button>
                                        <button style="display: none;" id="modaledit-js" data-dismiss="modal" aria-label="Close" class="btn purple">Modifier</button>
                                    </div>
                                </form> 
                            </div>
                        </div>
        ...
        <script src="vendor/js/ajax-sales.js"></script>
    </body>
</html>
<!-- end document-->
