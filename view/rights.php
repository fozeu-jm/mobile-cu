...
<html lang="fr">
    ...
    <body style="position: relative;" class="animsition">
                            ...
                            <div style="height: 100px; position: relative;" class="card ">
                                <div  class="card-header02 ">
                                    <div style="text-align: center;" class="header-icon purple" >
                                        <img  class="" src="view/images/icon/join-48.png" alt=""/>
                                        <h2 class="title-1 " style="display: inline; vertical-align: middle;">
                                            <span style=" border-right: 2px solid white; padding-right: 20px;" class="text-white">Droits D'Adhesion</span>                       
                                        </h2>
                                        <span style="color: white;; font-size: 1.6em; vertical-align: middle;">Gerer Les Droits d'Adhesion</span>
                                    </div> 
                                </div>
                            </div>
                        </div>
                    ...
                    <?php if (!is_bool($cycle12)) { ?>
                            ...
                            <div class="col col-sm-12">
                                <div class="card2  ">
                                    ...
                                    <form class="row" id="search-form" method="post" action="index.php">
                                        ...
                                        <input style="display: none;" type="text" name="action" value="print-rights">
                                    </form>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div  class="card-header02">
                                            <div style=" margin-bottom: 15px; height: 70px; text-align: center;" class="header-icon purple">
                                                <div style="margin-top: -7px;">
                                                    ...
                                                    <h2 class="title-1 " style=" display: inline; vertical-align: middle;">
                                                        <span style="margin-top: -20px;" class="hey text-white">Droits D'Adhesions</span>                       
                                                    </h2>
                                                </div>
                                            </div> 
                                        </div>
                                            ...
                                            <div style="" class="row">
                                                <div class="col-12 ">
                                                    <table id="table-js"  class="table table-hover">
                                                        ...
                                                        foreach ($list as $con) {
                                                            ?>
                                                            <tr id="select<?= $con->getarid() ?>" class="animate">
                                                                <td><?= $i; ?></td>
                                                                ...
                                                                <?php if(in_array($_SESSION['online']->getrole(), array('President','Vice-President','Comptable'))) {?>
                                                                <td> 
                                                                    <input id="actu-number1<?= $con->getarid() ?>" style="display: none;" type="text" value="<?= $i ?>"/>
                                                                    <button data-toggle="modal" data-target="#modalLoginForm" class="edit_cycles" id="editcyc_<?= $con->getarid() ?>"  >
                                                                        <img src="view/images/icon/edit.png" alt=""/>
                                                                    </button>
                                                                    <button class="delete_cycles" id="delcyc_<?= $con->getarid() ?>">
                        ...
                        <div class="row">
                            <div style="margin-top: -40px;" class="col-6">
                                Nombre Totale de Sanctions : <?= $nombre; ?>.
                            </div>
                            <div class="col-6">
                                <ul style="" class="pagination pagi">
                                    <?php if (!isset($_GET['page'])) { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == 1) {
                                                ?>
                                                <li class="active-page1 purple"><a  class="" href="index.php?action=rights&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-purple" href="index.php?action=rights&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == $_GET['page']) {
                                                ?>
                                                <li class="active-page1 purple"><a  class="text-purple" href="index.php?action=rights&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-purple" href="index.php?action=rights&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                                    ...
                                    <div class="modal-body mx-3">
                                        ...
                                        <div class="md-form mb-4">
                                            <select name="mem-id" id="mem-js" class="form-control validate">
                                                <option value="" disabled="">Adheré</option>
        ...
        <script src="vendor/js/ajax-rights.js"></script>
    </body>
</html>
<!-- end document-->
