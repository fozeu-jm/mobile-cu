...
<page backtop="20mm" backleft="10mm" backright="10mm" backbottom="0mm">
    ...
    <div style="box-shadow: 0px 0px 2px 5px; border-radius: 31px; width: 100%; text-align: center; margin-top: 50px; color: white; background-color:#697889;  ">
        <h1>Bilan Crédit Fond Social <?php if(isset($monthname)){echo $monthname;}else{echo " Fin De Cycle";}  ?></h1>
    </div>
    <table style="width: 400px; margin-top:60px; margin-left: 5px;">
        ...
        foreach ($printlist as $mem) {
            ...
            <tr class="animate">
                ...
                <td style="width:39%;"class="bord"> <?= $mem->getfullname() ?> </td>
                <td style="width:25%;text-align: center;"class="bord"> <?= $mem->getchequesno() ?> </td>
                <td style="width:35%;text-align: center;"class="bord"> <?= $mem->getreason() ?> </td>
                <td style="width:23%;text-align: center;"class="bord"> <?= $mem->getdate() ?> </td>
                <td style="width:35%;text-align: center;"class="bord"> <?= number_format($mem->getamount()) ?></td>
            </tr>
            <?php
            $totale += $mem->getamount();
            $i++;
        }
        ?>
        <tr style="border-radius: 2px 2px 0px 0px; background:#697889; text-align:center; color:white; ">
            <td colspan="5" style="width:10%; text-align: center;"class="bord">Total</td>
            <td  style="width:10%; text-align: center;"class="bord"><?= number_format($totale) ?></td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            <td style="text-align: center; padding-top:30px; color:grey">
                Copyright &copy; 2018 Mobile C-U. All rights reserved. Visitez nous sur : www.eyocreative.com
            </td>
        </tr>
    </table>
