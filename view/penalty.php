...
<html lang="fr">
    ...
    <body style="position: relative;" class="animsition">
                            ...
                            <div style="height: 100px; position: relative;" class="card ">
                                <div  class="card-header02 ">
                                    <div style="text-align: center;" class="header-icon blue" >
                                        <img  class="" src="view/images/icon/law-48.png" alt=""/>
                                        <h2 class="title-1 " style="display: inline; vertical-align: middle;">
                                            <span style=" border-right: 2px solid white; padding-right: 20px;" class="text-white">Sanctions</span>                       
                                        </h2>
                                        <span style="color: white;; font-size: 1.6em; vertical-align: middle;">Gerer Les Sanctions</span>
                                    </div> 
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col col-sm-12">
                                <div class="card2  ">
                                    ...
                                    <form class="row" id="search-form" method="post" action="index.php">
                                        ...
                                        <input style="display: none;" type="text" name="action" value="print-penalty">
                                    </form>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div  class="card-header02">
                                            <div style=" margin-bottom: 15px; height: 70px; text-align: center;" class="header-icon blue" >
                                                <div style="margin-top: -7px;">
                                                    ...
                                                    <h2 class="title-1 " style=" display: inline; vertical-align: middle;">
                                                        <span style="margin-top: -20px;" class="text-white">Sanctions</span>                       
                                                    </h2>
                                                </div>
                                            </div> 
                                        </div>
                                            ...
                                            <div style="" class="row">
                                                <div class="col-12 ">
                                                    <table id="table-js"  class="table table-hover">
                                                        ...
                                                        foreach ($list as $con) {
                                                            ?>
                                                            <tr id="select<?= $con->getpenid() ?>" class="animate">
                                                                <td><?= $i; ?></td>
                                                                ...
                                                                <?php if(in_array($_SESSION['online']->getrole(), array('President','Vice-President','Comptable'))) {?>
                                                                <td> 
                                                                    <input id="actu-number1<?= $con->getpenid() ?>" style="display: none;" type="text" value="<?= $i ?>"/>
                                                                    <button data-toggle="modal" data-target="#modalLoginForm" class="edit_cycles" id="editcyc_<?= $con->getpenid() ?>"  >
                                                                        <img src="view/images/icon/edit.png" alt=""/>
                                                                    </button>
                                                                    <button class="delete_cycles" id="delcyc_<?= $con->getpenid() ?>">
                                ...
                                <ul style="" class="pagination pagi">
                                    <?php if (!isset($_GET['page'])) { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == 1) {
                                                ?>
                                                <li class="active-page1 blue"><a  class="" href="index.php?action=penalty&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-blue" href="index.php?action=penalty&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                                        }
                                        ?>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        for ($i = 1; $i <= $pagin; $i++) {
                                            if ($i == $_GET['page']) {
                                                ?>
                                                <li class="active-page1 blue"><a  class="text-blue" href="index.php?action=penalty&page=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item1"><a class="text-blue" href="index.php?action=penalty&page=<?= $i ?>"><?= $i ?></a></li>
                                                <?php
                                            }
                                    ...
                                    <div class="modal-body mx-3">
                                        ...
                                        <div class="md-form mb-4">
                                            <select name="mem-id" id="mem-js" class="form-control validate">
                                                <option value="" disabled="">Membre Sanctionné</option>
                                        ...
                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Montant de la sanction</label>
                                        ...
                                        <div class="md-form mb-5">
                                            <label style="margin-top: -35px;" for="dep-date">Raison de la Sanction</label>
        ...
        <script src="vendor/js/ajax-penalty.js"></script>
    </body>
</html>
<!-- end document-->
